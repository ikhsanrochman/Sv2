...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top navbar-custom">
        <div class="container">
            <!-- Logo website -->
            <a class="navbar-brand fw-bold text-primary" href="#">Si‑Pemdora</a>
    ...
    <section class="hero d-flex align-items-center" id="home">
        <div class="container text-center hero-content">
            <h2 class="mb-2 fs-4">Haloooo Selamat Datang di <span class="text-info">Si‑Pemdora</span></h2>
    ...
    <section id="feature" class="bg-light py-5">
        <div class="container text-center">
            <h2 class="mb-2 fw-bold">Our Feature</h2>
            <!-- Garis pembatas dekoratif -->
            <div class="mx-auto" style="width: 80px; height: 3px; background-color: #666; margin-bottom: 40px;"></div>
    ...
    <section id="contact" class="py-5">
        <div class="container text-center contact-content">
            <h2 class="mb-2 fw-bold">Contact Us</h2>
            <!-- Garis pembatas dekoratif -->
            <div class="mx-auto" style="width: 80px; height: 3px; background-color: #fff; margin-bottom: 40px;"></div>

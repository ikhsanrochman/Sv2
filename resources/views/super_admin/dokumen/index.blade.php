                ...
                <table class="table table-hover mb-0" id="documentsTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="{{ route('super_admin.documents.show', $document->id) }}" class="btn btn-info btn-sm me-2">Detail</a>
                                    <a href="{{ route('super_admin.documents.edit', $document->id) }}" class="btn btn-warning btn-sm me-2">Edit</a>

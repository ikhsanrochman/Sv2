    ...
    <div class="d-flex justify-content-between bg-dark-blue py-2 px-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="#" class="text-decoration-none text-white">Home / Laporan</a></li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end mb-3">
                <input type="text" id="search-project" class="form-control" style="width: 300px;" placeholder="Cari proyek, keterangan, tanggal, atau jumlah...">
            </div>

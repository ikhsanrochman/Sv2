    ...
    <div class="d-flex justify-content-between bg-dark-blue py-2 px-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('super_admin.perizinan.detail', $perizinan->project_id) }}" class="text-decoration-none text-white">Detail Perizinan</a></li>
                <li class="breadcrumb-item active text-white" aria-current="page">Edit Perizinan</li>
            </ol>
        </nav>
    </div>
</div>
